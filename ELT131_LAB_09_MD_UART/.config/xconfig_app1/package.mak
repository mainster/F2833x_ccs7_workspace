...
.dlls,28FP .dlls: app1.p28FP

-include package/cfg/app1_p28FP.mak
-include package/cfg/app1_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app1_p28FP.dep
endif
app1.p28FP: package/cfg/app1_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
app1.p28FP package/cfg/app1_p28FP.c: .libraries,28FP
endif

package/cfg/app1_p28FP.c package/cfg/app1_p28FP.h package/cfg/app1_p28FP.xdl: override _PROG_NAME := app1.x28FP
package/cfg/app1_p28FP.c: package/cfg/app1_p28FP.cfg
package/cfg/app1_p28FP.xdc.inc: package/cfg/app1_p28FP.xdl
package/cfg/app1_p28FP.xdl package/cfg/app1_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/app1_p28FP.cfg
	-$(RM) package/cfg/app1_p28FP.dep
	-$(RM) package/cfg/app1_p28FP.c
	-$(RM) package/cfg/app1_p28FP.xdc.inc

clean,28FP::
	-$(RM) app1.p28FP
.executables,28FP .executables: app1.x28FP

app1.x28FP: |app1.p28FP

-include package/cfg/app1.x28FP.mak
app1.x28FP: package/cfg/app1_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/lnk2000 -w -q -u _c_int00  -q -o $@ package/cfg/app1_p28FP.o28FP   package/cfg/app1_p28FP.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
app1.x28FP: export C_DIR=
app1.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/:$(PATH)

app1.test test,28FP test: app1.x28FP.test

app1.x28FP.test:: app1.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app1.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app1.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,app1.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app1_p28FP.o28FP,copy : package/cfg/app1_p28FP.o28FP
app1_p28FP.s28FP,copy : package/cfg/app1_p28FP.s28FP
