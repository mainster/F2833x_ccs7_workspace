...
app.x28FP: package/cfg/app_p28FP.o28FP 
	...
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/lnk2000 -w -q -u _c_int00  -q -o $@ package/cfg/app_p28FP.o28FP   package/cfg/app_p28FP.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
