...
package/%.xdc.inc package/%_xconfig_app2.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_app2" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: app2.p28FP

-include package/cfg/app2_p28FP.mak
-include package/cfg/app2_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app2_p28FP.dep
endif
app2.p28FP: package/cfg/app2_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
app2.p28FP package/cfg/app2_p28FP.c: .libraries,28FP
endif

package/cfg/app2_p28FP.c package/cfg/app2_p28FP.h package/cfg/app2_p28FP.xdl: override _PROG_NAME := app2.x28FP
package/cfg/app2_p28FP.c: package/cfg/app2_p28FP.cfg
package/cfg/app2_p28FP.xdc.inc: package/cfg/app2_p28FP.xdl
package/cfg/app2_p28FP.xdl package/cfg/app2_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/app2_p28FP.cfg
	-$(RM) package/cfg/app2_p28FP.dep
	-$(RM) package/cfg/app2_p28FP.c
	-$(RM) package/cfg/app2_p28FP.xdc.inc

clean,28FP::
	-$(RM) app2.p28FP
.executables,28FP .executables: app2.x28FP

app2.x28FP: |app2.p28FP

-include package/cfg/app2.x28FP.mak
app2.x28FP: package/cfg/app2_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/lnk2000 -w -q -u _c_int00  -q -o $@ package/cfg/app2_p28FP.o28FP   package/cfg/app2_p28FP.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
app2.x28FP: export C_DIR=
app2.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/:$(PATH)

app2.test test,28FP test: app2.x28FP.test

app2.x28FP.test:: app2.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app2.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app2.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,app2.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app2_p28FP.o28FP,copy : package/cfg/app2_p28FP.o28FP
app2_p28FP.s28FP,copy : package/cfg/app2_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_app2
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_app2.tar.dep
endif
package/rel/xconfig_app2/xconfig_app2/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_app2/xconfig_app2/package/package.rel.xml: package/build.cfg
package/rel/xconfig_app2/xconfig_app2/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_app2/xconfig_app2/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_app2.tar: package/rel/xconfig_app2.xdc.inc package/rel/xconfig_app2/xconfig_app2/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_app2.xdc.inc,package/rel/xconfig_app2.tar.dep)


release release,xconfig_app2: all xconfig_app2.tar
clean:: .clean
	-$(RM) xconfig_app2.tar
	-$(RM) package/rel/xconfig_app2.xdc.inc
	-$(RM) package/rel/xconfig_app2.tar.dep
