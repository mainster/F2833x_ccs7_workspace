...
override PKGDIR = xconfig_bigtime
...
package/%.xdc.inc package/%_xconfig_bigtime.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_bigtime" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28L .dlls: bigtime.p28L

-include package/cfg/bigtime_p28L.mak
-include package/cfg/bigtime_p28L.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/bigtime_p28L.dep
endif
bigtime.p28L: package/cfg/bigtime_p28L.xdl
	@


ifeq (,$(wildcard .libraries,28L))
bigtime.p28L package/cfg/bigtime_p28L.c: .libraries,28L
endif

package/cfg/bigtime_p28L.c package/cfg/bigtime_p28L.h package/cfg/bigtime_p28L.xdl: override _PROG_NAME := bigtime.x28L
package/cfg/bigtime_p28L.c: package/cfg/bigtime_p28L.cfg
package/cfg/bigtime_p28L.xdc.inc: package/cfg/bigtime_p28L.xdl
package/cfg/bigtime_p28L.xdl package/cfg/bigtime_p28L.c: .interfaces

clean:: clean,28L
	-$(RM) package/cfg/bigtime_p28L.cfg
	-$(RM) package/cfg/bigtime_p28L.dep
	-$(RM) package/cfg/bigtime_p28L.c
	-$(RM) package/cfg/bigtime_p28L.xdc.inc

clean,28L::
	-$(RM) bigtime.p28L
.executables,28L .executables: bigtime.x28L

bigtime.x28L: |bigtime.p28L

-include package/cfg/bigtime.x28L.mak
bigtime.x28L: package/cfg/bigtime_p28L.o28L 
	$(RM) $@
	@$(MSG) lnk28L $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_large.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/bigtime_p28L.o28L   package/cfg/bigtime_p28L.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_large.rootDir)/lib/libc.a
	
bigtime.x28L: export C_DIR=
bigtime.x28L: PATH:=$(ti.targets.C28_large.rootDir)/bin/:$(PATH)

bigtime.test test,28L test: bigtime.x28L.test

bigtime.x28L.test:: bigtime.x28L
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 bigtime.x28L.test
else
	@$(MSG) running $<  ...
	$(call EXEC.bigtime.x28L, ) 
endif

clean,28L::
	-$(RM) $(wildcard .tmp,bigtime.x28L,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
bigtime_p28L.o28L,copy : package/cfg/bigtime_p28L.o28L
bigtime_p28L.s28L,copy : package/cfg/bigtime_p28L.s28L

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_bigtime
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_bigtime.tar.dep
endif
package/rel/xconfig_bigtime/xconfig_bigtime/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_bigtime/xconfig_bigtime/package/package.rel.xml: package/build.cfg
package/rel/xconfig_bigtime/xconfig_bigtime/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_bigtime/xconfig_bigtime/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_bigtime.tar: package/rel/xconfig_bigtime.xdc.inc package/rel/xconfig_bigtime/xconfig_bigtime/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_bigtime.xdc.inc,package/rel/xconfig_bigtime.tar.dep)


release release,xconfig_bigtime: all xconfig_bigtime.tar
clean:: .clean
	-$(RM) xconfig_bigtime.tar
	-$(RM) package/rel/xconfig_bigtime.xdc.inc
	-$(RM) package/rel/xconfig_bigtime.tar.dep
