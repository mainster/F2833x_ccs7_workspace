...
ti.targets.C28_float.rootDir ?= /opt/ti/ccsv7/tools/compiler/ti-cgt-c2000_17.3.0.STS
...
.dlls,28FP .dlls: idle.p28FP

-include package/cfg/idle_p28FP.mak
-include package/cfg/idle_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/idle_p28FP.dep
endif
idle.p28FP: package/cfg/idle_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
idle.p28FP package/cfg/idle_p28FP.c: .libraries,28FP
endif

package/cfg/idle_p28FP.c package/cfg/idle_p28FP.h package/cfg/idle_p28FP.xdl: override _PROG_NAME := idle.x28FP
package/cfg/idle_p28FP.c: package/cfg/idle_p28FP.cfg
package/cfg/idle_p28FP.xdc.inc: package/cfg/idle_p28FP.xdl
package/cfg/idle_p28FP.xdl package/cfg/idle_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/idle_p28FP.cfg
	-$(RM) package/cfg/idle_p28FP.dep
	-$(RM) package/cfg/idle_p28FP.c
	-$(RM) package/cfg/idle_p28FP.xdc.inc

clean,28FP::
	-$(RM) idle.p28FP
.executables,28FP .executables: idle.x28FP

idle.x28FP: |idle.p28FP

-include package/cfg/idle.x28FP.mak
idle.x28FP: package/cfg/idle_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/idle_p28FP.o28FP   package/cfg/idle_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
idle.x28FP: export C_DIR=
idle.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/:$(PATH)

idle.test test,28FP test: idle.x28FP.test

idle.x28FP.test:: idle.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 idle.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.idle.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,idle.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
idle_p28FP.o28FP,copy : package/cfg/idle_p28FP.o28FP
idle_p28FP.s28FP,copy : package/cfg/idle_p28FP.s28FP
