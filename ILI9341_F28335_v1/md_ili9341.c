...
/* Pin definitions */
#define ILI934x_RST_SET				GPIO_SetBits 	(ILI934x_RST_PORT, ILI934x_RST_PIN)
#define ILI934x_RST_RESET			GPIO_ResetBits 	(ILI934x_RST_PORT, ILI934x_RST_PIN)
#define ILI934x_CS_SET				GPIO_SetBits 	(ILI934x_CS_PORT, ILI934x_CS_PIN)
#define ILI934x_CS_RESET			GPIO_ResetBits 	(ILI934x_CS_PORT, ILI934x_CS_PIN)
#define ILI934x_WRX_SET				GPIO_SetBits 	(ILI934x_WRX_PORT, ILI934x_WRX_PIN)
#define ILI934x_WRX_RESET			GPIO_ResetBits	(ILI934x_WRX_PORT, ILI934x_WRX_PIN)

/* Private defines */
#define ILI934x_RESET				0x01
#define ILI934x_SLEEP_OUT			0x11
#define ILI934x_GAMMA				0x26
#define ILI934x_DISPLAY_OFF			0x28
#define ILI934x_DISPLAY_ON			0x29
#define ILI934x_COLUMN_ADDR			0x2A
#define ILI934x_PAGE_ADDR			0x2B
#define ILI934x_GRAM				0x2C
#define ILI934x_MAC					0x36
#define ILI934x_PIXEL_FORMAT		0x3A
#define ILI934x_WDB					0x51
#define ILI934x_WCD					0x53
#define ILI934x_RGB_INTERFACE		0xB0
#define ILI934x_FRC					0xB1
#define ILI934x_BPC					0xB5
#define ILI934x_DFC					0xB6
#define ILI934x_POWER1				0xC0
#define ILI934x_POWER2				0xC1
#define ILI934x_VCOM1				0xC5
#define ILI934x_VCOM2				0xC7
#define ILI934x_POWERA				0xCB
#define ILI934x_POWERB				0xCF
#define ILI934x_PGAMMA				0xE0
#define ILI934x_NGAMMA				0xE1
#define ILI934x_DTCA				0xE8
#define ILI934x_DTCB				0xEA
#define ILI934x_POWER_SEQ			0xED
#define ILI934x_3GAMMA_EN			0xF2
#define ILI934x_INTERFACE			0xF6
#define ILI934x_PRC					0xF7

/* Pin functions */
uint16_t ILI934x_x;
uint16_t ILI934x_y;
MD_ILI931_Options_t ILI934x_Opts;
uint8_t ILI934x_INT_CalledFromPuts = 0;
...
void MD_ILI934x_Init() {
	...
	/* Init RST pin */
	MD_GPIO_Init(ILI934x_RST_PORT, ILI934x_RST_PIN, MD_GPIO_Mode_OUT, MD_GPIO_OType_PP, MD_GPIO_PuPd_UP, MD_GPIO_Speed_Low);
...
void MD_ILI934x_InitLCD(void) {
	...
	/* Software reset */
	MD_ILI934x_SendCommand(ILI934x_RESET);
	MD_ILI934x_Delay(50000);
	
	MD_ILI934x_SendCommand(ILI934x_POWERA);
	MD_ILI934x_SendData(0x39);
	MD_ILI934x_SendData(0x2C);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x34);
	MD_ILI934x_SendData(0x02);
	MD_ILI934x_SendCommand(ILI934x_POWERB);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0xC1);
	MD_ILI934x_SendData(0x30);
	MD_ILI934x_SendCommand(ILI934x_DTCA);
	MD_ILI934x_SendData(0x85);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x78);
	MD_ILI934x_SendCommand(ILI934x_DTCB);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendCommand(ILI934x_POWER_SEQ);
	MD_ILI934x_SendData(0x64);
	MD_ILI934x_SendData(0x03);
	MD_ILI934x_SendData(0x12);
	MD_ILI934x_SendData(0x81);
	MD_ILI934x_SendCommand(ILI934x_PRC);
	MD_ILI934x_SendData(0x20);
	MD_ILI934x_SendCommand(ILI934x_POWER1);
	MD_ILI934x_SendData(0x23);
	MD_ILI934x_SendCommand(ILI934x_POWER2);
	MD_ILI934x_SendData(0x10);
	MD_ILI934x_SendCommand(ILI934x_VCOM1);
	MD_ILI934x_SendData(0x3E);
	MD_ILI934x_SendData(0x28);
	MD_ILI934x_SendCommand(ILI934x_VCOM2);
	MD_ILI934x_SendData(0x86);
	MD_ILI934x_SendCommand(ILI934x_MAC);
	MD_ILI934x_SendData(0x48);
	MD_ILI934x_SendCommand(ILI934x_PIXEL_FORMAT);
	MD_ILI934x_SendData(0x55);
	MD_ILI934x_SendCommand(ILI934x_FRC);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x18);
	MD_ILI934x_SendCommand(ILI934x_DFC);
	MD_ILI934x_SendData(0x08);
	MD_ILI934x_SendData(0x82);
	MD_ILI934x_SendData(0x27);
	MD_ILI934x_SendCommand(ILI934x_3GAMMA_EN);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendCommand(ILI934x_COLUMN_ADDR);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0xEF);
	MD_ILI934x_SendCommand(ILI934x_PAGE_ADDR);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x01);
	MD_ILI934x_SendData(0x3F);
	MD_ILI934x_SendCommand(ILI934x_GAMMA);
	MD_ILI934x_SendData(0x01);
	MD_ILI934x_SendCommand(ILI934x_PGAMMA);
	...
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendCommand(ILI934x_NGAMMA);
	MD_ILI934x_SendData(0x00);
	MD_ILI934x_SendData(0x0E);
	...
	MD_ILI934x_SendData(0x0F);
	MD_ILI934x_SendCommand(ILI934x_SLEEP_OUT);

	MD_ILI934x_Delay(1000000);

	MD_ILI934x_SendCommand(ILI934x_DISPLAY_ON);
	MD_ILI934x_SendCommand(ILI934x_GRAM);
}
...
void MD_ILI934x_DisplayOff(void) {
	MD_ILI934x_SendCommand(ILI934x_DISPLAY_OFF);
}
